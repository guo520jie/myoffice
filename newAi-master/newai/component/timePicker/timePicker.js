...
Component({
  ...
  methods: {
            ...
            if (nMonth == pMonth) {
              ...
              if (nDay == tDay) {
                if (nDay == pDay) {
                  ...
                  if (nHours == tHours) {
                    if (nHours == pHours) {
                      for (let i = tMinutes; i <= pMinutes; i += 5) {
                        if (i < 10) {
                      ...
                      data.index[4] =
                        nMinutes - tMinutes < 0 ? 0 : nMinutes - tMinutes
                    } else {
                      for (let i = tMinutes; i <= 59; i += 5) {
                        if (i < 10) {
                          data.division.push({ id: i, name: '0' + i + '分' })
                        } else {
                          data.division.push({ id: i, name: i + '分' })
    ...
    pickerColumnChange: function(e) {
      ...
      //   e.detail.value=+e.detail.value*5
      // }
      ...
      let newDate = this._getDefaultDate(
        cYear + '-' + cMonth + '-' + cDay + ' ' + cTime + ':' + +cDivision / 5
      )
